...
ti_slingshot <- function(
  ...
  # docker运行脚本: https://github.com/dynverse/ti_slingshot/blob/master/package/R/ti_slingshot.R
  # wrapper运行脚本: https://github.com/dynverse/ti_slingshot/blob/master/run.R
  method_choose_backend(
    package_repository = "dynverse/ti_slingshot/package", # 注意这里的不是slingshot官网的包, 而是自己的包, 里面的调用是封装好的
